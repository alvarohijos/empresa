<%@ Page Title="" Language="C#" MasterPageFile="~/forms/departments/departments.Master" AutoEventWireup="true" CodeBehind="actualizar.aspx.cs" Inherits="PRESENTACION.forms.departments.actualizar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="tituloPagina" runat="server">
<h3 class="mt-4">DEPARTMENTS</h3>
<ol class="breadcrumb mb-4">
    <li class="breadcrumb-item active">Actualizar Departments</li>
</ol>
</asp:Content>
...
<div class="card-body">
    ...
    <asp:Button class="btn btn-success btn-sm" Style="float: right" ID="btn_actualizar" runat="server" Text="ACTUALIZAR" OnClick="btn_actualizar_Click" OnClientClick="return confirm('Estas seguro de ACTUALIZAR este Departamento?');" />
