<%@ Page Title="" Language="C#" MasterPageFile="~/forms/jobs/jobs.Master" AutoEventWireup="true" CodeBehind="crear.aspx.cs" Inherits="PRESENTACION.forms.jobs.crear" %>
...
<div class="card-body">
    <%--<form id="form1" runat="server">--%>
        ...
        <asp:Button class="btn btn-success btn-sm" Style="float: right" ID="btn_crear" runat="server" Text="CREAR" OnClick="btn_crear_Click" OnClientClick="return confirm('Estas seguro de crear el cargo?');" />
