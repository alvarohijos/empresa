<%@ Page Title="" Language="C#" MasterPageFile="~/forms/jobs/jobs.Master" AutoEventWireup="true" CodeBehind="eliminar.aspx.cs" Inherits="PRESENTACION.forms.jobs.eliminar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="tituloPagina" runat="server">
<h3 class="mt-4">JOBS</h3>
<ol class="breadcrumb mb-4">
    <li class="breadcrumb-item active">Eliminar Job</li>
</ol>
</asp:Content>
...
<div class="card-body">
    <%--<form id="form1" runat="server">--%>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <div class="form-floating mb-3 mb-md-0">
                    ...
                    <asp:TextBox type="text" AutoComplete="off" placeholder="Enter your first name" Class="form-control" ID="textsalariominimo" runat="server"></asp:TextBox>
        ...
        <asp:Button class="btn btn-success btn-sm" Style="float: right" ID="btn_eliminar" runat="server" Text="ELIMINAR" OnClick="btn_eliminar_Click" OnClientClick="return confirm('Estas seguro de crear el cargo?');" />
